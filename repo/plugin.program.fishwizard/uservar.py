...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR red][B]Open[/B][/COLOR]Wizard'
BUILDERNAME = 'fishWizard'
EXCLUDES = [ADDON_ID, 'repository.fish']
# Text File with build info in it. Please read https://github.com/a4k-openproject/plugin.program.openwizard/wiki/Installing-Builds
BUILDFILE = 'http://fishbuild.onlinewebshop.net/wizard/build.txt'
